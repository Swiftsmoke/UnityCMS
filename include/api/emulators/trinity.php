...
class Trinity extends BaseAccount {
  /**
  ...
  */
  function load( $username, $password = '' ) {
    ...
    Database::query( "SELECT * FROM `account_access` WHERE `id` = \"" . $this->userid() . "\"", $this->_con );
  ...
  */
  ...
  /**
  * Parse Array Into Trinity Class
  * 
  * @param array
  * @access public
  ...
  */
  function ParseArray( $array ) {
    ...
    Database::query( "SELECT * FROM `account_access` WHERE `id` = \"" . $acct->userid() . "\"", $this->_con );
  ...
  function UpdateEmail( $newemail ) {
    ...
    $this->email( $newemail );
    return Database::query( "UPDATE `account` SET `email` = \"" . $this->email() . "\" WHERE `id` = '" . $this->userid() . "'", $this->_con );
  }
  ...
  */
  ...
  /**
    ...
    * @return void
    */
  function getLinkedAccounts( $acctid ) {
    if ( $acctid <= 0 )
      return;
  ...
  */
  function SaveToDB() {
    $sql = "INSERT INTO `account` SET `username` = \"" . $this->username() . "\", `sha_pass_hash` = \"" . $this->encryptedpass() . "\", `email` = \"" . $this->email() . "\"";
